...
(cl:defmethod cl:initialize-instance :after ((m <AddtwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddtwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_package-srv:<AddtwoInts-request> is deprecated: use my_package-srv:AddtwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <AddtwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package-srv:a-val is deprecated.  Use my_package-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <AddtwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package-srv:b-val is deprecated.  Use my_package-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddtwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddtwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_package-srv:<AddtwoInts-response> is deprecated: use my_package-srv:AddtwoInts-response instead.")))
