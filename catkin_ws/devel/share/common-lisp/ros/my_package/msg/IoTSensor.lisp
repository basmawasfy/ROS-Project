...
(cl:defmethod cl:initialize-instance :after ((m <IoTSensor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IoTSensor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_package-msg:<IoTSensor> is deprecated: use my_package-msg:IoTSensor instead.")))
...
(cl:defmethod temperature-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package-msg:temperature-val is deprecated.  Use my_package-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'humidity-val :lambda-list '(m))
(cl:defmethod humidity-val ((m <IoTSensor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_package-msg:humidity-val is deprecated.  Use my_package-msg:humidity instead.")
  (humidity m))
